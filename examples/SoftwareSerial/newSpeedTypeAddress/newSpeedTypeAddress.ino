...
//   - если скорость известна, то строки с другими скоростями можно удалить.                       //
     ...
     if(!f){ rs485.begin(  2400); wait_rs485(); Serial.print('.'); f=socket.begin(); }             //   Инициируем работу с модулем на скорости   2400, без указания адреса (адрес будет найден автоматически).
     if(!f){ rs485.begin(  4800); wait_rs485(); Serial.print('.'); f=socket.begin(); }             //   Инициируем работу с модулем на скорости   4800, без указания адреса (адрес будет найден автоматически).
     if(!f){ rs485.begin(  9600); wait_rs485(); Serial.print('.'); f=socket.begin(); }             //   Инициируем работу с модулем на скорости   9600, без указания адреса (адрес будет найден автоматически).
     if(!f){ rs485.begin( 19200); wait_rs485(); Serial.print('.'); f=socket.begin(); }             //   Инициируем работу с модулем на скорости  19200, без указания адреса (адрес будет найден автоматически).
     if(!f){ rs485.begin( 38400); wait_rs485(); Serial.print('.'); f=socket.begin(); }             //   Инициируем работу с модулем на скорости  38400, без указания адреса (адрес будет найден автоматически).
     if(!f){ rs485.begin( 57600); wait_rs485(); Serial.print('.'); f=socket.begin(); }             //   Инициируем работу с модулем на скорости  57600, без указания адреса (адрес будет найден автоматически).
     if(!f){ rs485.begin(115200); wait_rs485(); Serial.print('.'); f=socket.begin(); }             //   Инициируем работу с модулем на скорости 115200, без указания адреса (адрес будет найден автоматически).
